...
AUD_CLS_DS = ['audioset', 'esc50', 'fakeavceleb_dataset']
VID_CLS_DS = ['kinetics400', 'fakeavceleb_dataset']
...
CLS_DS = {'esc50': {'num_classes': 50,
                    'splits': [1, 2, 3, 4, 5],
                    'total_steps': 10000},
          'fakeavceleb_dataset': {'num_classes': 2}
          }

TEXT_DS = {'msrvtt1000': {'num_clips': 1000}}
