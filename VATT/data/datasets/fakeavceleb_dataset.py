...
class ToyFactory(loading.BaseDMVRFactory, abc.ABC):
  ...
  _BASE_DIR = 'vatt/fakeavceleb_tfrec'
  _NUM_CLASSES = 2
  ...
  def __init__(self, subset = 'train', split = 2):
  ...
  def _build(self,
             ...
             num_samples = 48_000,  # 48000 (Hz) * 10 / 10 (fps)
             audio_stride = 1,
    ...
    processing.add_label(
        ...
        decoder_builder=self.decoder_builder,
        preprocessor_builder=self.preprocessor_builder,
        input_label_index_feature_name='clip/label/index',
        input_label_name_feature_name='clip/label/text',
